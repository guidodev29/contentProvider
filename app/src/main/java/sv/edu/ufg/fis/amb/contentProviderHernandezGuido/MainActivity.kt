package sv.edu.ufg.fis.amb.contentProviderHernandezGuido
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createImageUri():Uri {
        ...
        return FileProvider.getUriForFile(this,"sv.edu.ufg.fis.amb.contentProviderHernandezGuido.fileProvide",imagen)
    }
